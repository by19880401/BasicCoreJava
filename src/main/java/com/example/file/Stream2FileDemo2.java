...
/**
 * InputStream转File
 * 第二种方式：使用transferTo (本质上还是使用了流 只不过是封装了步骤)
 * 会生成临时文件，转化完成后是要删除临时文件的，临时文件只起到了过渡的作用
 */
public class Stream2FileDemo2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 操作完上面的步骤之后，需要删除生成的临时文件，因为它的过渡作用已结束，我们的目标只是转化为文件，转化完成，起过渡作用的临时文件已无用
