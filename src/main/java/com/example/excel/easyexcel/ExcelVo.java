...
public class ExcelVo {
    ...
    public String toString() {
        return "ExcelVo{" + "wbsName='" + wbsName + '\'' + ", startStr='" + startStr + '\'' + ", endStr='" + endStr
            + '\'' + ", lastMonthEndPlanProgress='" + lastMonthEndPlanProgress + '\'' + ", monthActualProgress='"
            + monthActualProgress + '\'' + ", websId='" + websId + '\'' + ", question='" + question + '\'' + '}';
    }
}
